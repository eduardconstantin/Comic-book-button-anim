...
export interface Printer<T = any> {
    ...
    embed?: ((path: AstPath<T>, print: (path: AstPath<T>) => Doc, textToDoc: (text: string, options: Options) => Doc, options: ParserOptions<T>) => Doc | null) | undefined;
...
export type SupportOption = IntSupportOption | IntArraySupportOption | BooleanSupportOption | BooleanArraySupportOption | ChoiceSupportOption | PathSupportOption | PathArraySupportOption;
...
export namespace doc {
    namespace builders {
        type DocCommand = Align | BreakParent | Concat | Cursor | Fill | Group | IfBreak | Indent | IndentIfBreak | Label | Line | LineSuffix | LineSuffixBoundary | Trim;
