...
import { History, InitialEntry, Location, Path, To } from "./react-router-node_modules-history-index";
import { Action as NavigationType } from "./react-router-node_modules-history-index";
export { Location, Path, To, NavigationType };
/**
 ...
 */
export declare type Navigator = Pick<History, Exclude<keyof History, "action" | "location" | "back" | "forward" | "listen" | "block">>;
