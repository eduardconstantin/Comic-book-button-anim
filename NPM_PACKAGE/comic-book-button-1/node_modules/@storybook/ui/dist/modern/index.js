...
console.error(e);return false;}};const write=memoize(1)(changes=>{try{store.local.set(`storybook-layout`,changes);}catch(e){// eslint-disable-next-line no-console
