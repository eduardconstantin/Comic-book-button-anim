...
var memoize$1 = require('memoizerific');
...
var memoize__default = /*#__PURE__*/_interopDefaultLegacy(memoize$1);
...
const createReset = memoize__default["default"](1)(({
  typography
}) => ({
  body: {
...
const createGlobal = memoize__default["default"](1)(({
  color,
  background,
  typography
}) => {
